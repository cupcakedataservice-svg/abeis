...
const STATEMENTS = [
  {
    key: "dataCollection",
    text: "I consent to the collection of my behavioral data during this assessment.",
  },
  {
    key: "webcamRecording",
    text: "I understand that my webcam video will be recorded throughout the assessment.",
  },
  {
    key: "screenRecording",
    text: "I understand that my screen activity will be recorded throughout the assessment.",
  },
  {
    key: "behavioralFeatures",
    text: "I understand that my mouse movements, keyboard interactions, typing behavior, response times, and other behavioral features will be collected for research and analysis purposes.",
  },
  {
  ...
  {
    key: "baselineUsage",
    text: "I understand that my behavioral data will be used to create personalized baseline profiles and may be compared against future assessment sessions.",
  },
  {
    key: "rightToStop",
...
export default function ConsentPage() {
  ...
  const canStart =
    ...
    media.screenPermission === "granted";
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      const acknowledgedStatements = STATEMENTS.reduce(
      ...
      navigate(`/assessment/${assessmentType}`, {
        state: { consentId: consentRecord.consentId, sessionId },
      });
    } catch (err) {
      setPermissionError(
  ...
  return (
    <div className="min-h-screen px-4 py-12 max-w-2xl mx-auto">
      ...
      <p className="text-white/50 text-sm mb-8">
        Please read and agree to the following before starting the{" "}
      ...
      <div className="card p-5 mb-6">
        <p className="text-sm text-white/70 mb-3">
          This assessment requires camera and screen recording access. Both are
          mandatory — the assessment cannot begin if either is denied.
        </p>
        <button
        ...
        {permissionError && (
          <p className="text-sm text-red-400 mt-3">{permissionError}</p>
        )}
      </div>
